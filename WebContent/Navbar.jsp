...
<body>
      ...
      <li class="layui-nav-item" style="float: right;">
        <a href="<%=request.getContextPath()%>/ToPersonalCenterServlet"><img src="//t.cn/RCzsdCq" class="layui-nav-img">个人中心</a>
      ...
      <li class="layui-nav-item" style="float: right;">
        <a href="<%=request.getContextPath()%>/MainPage.jsp">回到首页</a>
      </li>
